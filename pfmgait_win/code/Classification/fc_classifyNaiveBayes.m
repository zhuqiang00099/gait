function [vidEstClass, scores, acc_test, acc_test_pc] = fc_classifyNaiveBayes(samples, labels, model)
% [vidEstClass, svmscores, acc_test, acc_test_pc] = fc_classifyNaiveBayes(samples, labels, model)
